...
<template>
    ...
    <transition name="window" appear>
        <dialog open v-show="show" class="fixed top-40 left-0 w-3/4 h-96 max-w-lg flex flex-col gap-2 rounded-3xl shadow-xl pl-4 overflow-hidden z-20 bg-white dark:bg-slate-800 text-black dark:text-white">
